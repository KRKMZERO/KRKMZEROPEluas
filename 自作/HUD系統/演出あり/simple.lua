function onCreatePost()
	...
	makeLuaText('SongnemeText', 'Score', 1210, 'timeTxt.X', 500)--675
...
function onSongStart()
	doTweenAlpha('SongnemeTween', 'SongnemeText', 1, 1, 'linear')
...
function onTimerCompleted(tag, loops, loopsLeft)
	if tag == 'timeTxtWait' then
		...
		doTweenY('SongnemeVtween', 'SongnemeText', 675, 2.5, 'QuintIn')--CircIn
