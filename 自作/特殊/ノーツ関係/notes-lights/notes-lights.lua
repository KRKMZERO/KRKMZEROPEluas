...
function onCreate()
	...
	makeGraphic('player1', 110,screenHeight+200, notecolor1)
    makeGraphic('player2', 110,screenHeight+200, notecolor2)
    makeGraphic('player3', 110,screenHeight+200, notecolor3)
    makeGraphic('player4', 110,screenHeight+200, notecolor4)
	...
	makeGraphic('opponent1', 110,screenHeight+200, notecolor1)
    makeGraphic('opponent2', 110,screenHeight+200, notecolor2)
    makeGraphic('opponent3', 110,screenHeight+200, notecolor3)
    makeGraphic('opponent4', 110,screenHeight+200, notecolor4)
