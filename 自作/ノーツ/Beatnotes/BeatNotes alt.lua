...
function onBeatHit()
	if curBeat % 2 == 0 then
		-- Opponent's notes
		noteTweenAlpha('normal001','0','1','0.25','linear')
		noteTweenAlpha('normal002','1','1','0.25','linear')
		noteTweenAlpha('normal003','2','1','0.25','linear')
		noteTweenAlpha('normal004','3','1','0.25','linear')
		--BFs notes
