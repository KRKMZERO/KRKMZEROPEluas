...
function goodNoteHit(membersIndex, noteData, noteType, isSustainNote)
   if noteData == 0 then
      if getPropertyFromGroup("notes", membersIndex, "rating") == "sick" then
         ...
         doTweenY("1assessmentT"..C1,"1assessment"..C1,defaultPlayerStrumY0 - 100,Tweenspeed001,'Backout')
         doTweenAlpha("1assessmentT2"..C1,"1assessment"..C1,0,Tweenspeed001,'Backout')
   ...
   if noteData == 1 then
      if getPropertyFromGroup("notes", membersIndex, "rating") == "sick" then
         ...
         doTweenY("2assessmentT"..C2,"2assessment"..C2,defaultPlayerStrumY1 - 100,Tweenspeed001,'Backout')
         doTweenAlpha("2assessmentT2"..C2,"2assessment"..C2,0,Tweenspeed001,'Backout')
   ...
   if noteData == 2 then
      if getPropertyFromGroup("notes", membersIndex, "rating") == "sick" then
         ...
         doTweenY("3assessmentT"..C3,"3assessment"..C3,defaultPlayerStrumY2 - 100,Tweenspeed001,'Backout')
         doTweenAlpha("3assessmentT2"..C3,"3assessment"..C3,0,Tweenspeed001,'Backout')
   ...
   if noteData == 3 then
      if getPropertyFromGroup("notes", membersIndex, "rating") == "sick" then
         ...
         doTweenY("4assessmentT"..C4,"4assessment"..C4,defaultPlayerStrumY3 - 100,Tweenspeed001,'Backout')
         doTweenAlpha("4assessmentT2"..C4,"4assessment"..C4,0,Tweenspeed001,'Backout')
...
function noteMiss(membersIndex, noteData, noteType, isSustainNote)
   ...
   if noteData == 3 then
      ...
      setTextAlignment("4assessment"..C4, "left")
      setTextSize('4assessment'..C4, 40);
      setTextColor('4assessment'..C4, 'FA0000');
      setObjectCamera('4assessment'..C4, 'hud');
      doTweenY("4assessmentT"..C4,"4assessment"..C4,defaultPlayerStrumY3 - 100,Tweenspeed001,'Backout')
      doTweenAlpha("4assessmentT2"..C4,"4assessment"..C4,0,Tweenspeed001,'Backout')
      addLuaText('4assessment'..C4)
