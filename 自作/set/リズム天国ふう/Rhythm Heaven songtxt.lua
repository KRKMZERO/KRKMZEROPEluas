...
function onCreate()
	...
	--texts
	makeLuaText('Luatext001',MODSONGs,200,x,screenHeight -100); -- x y values go on the second and third 0's
	...
	setProperty('Luatext001.x', -200)

	makeLuaText('Luatext002',MODCLAR,200,x,screenHeight -50); -- x y values go on the second and third 0's
...
function onStepHit()
	if curStep == 127 then
		...
		doTweenX('Luatext001tweenX', 'Luatext001', 440, 1, 'QuintIn')--QuintIn
		doTweenX('Luatext002tweenX', 'Luatext002', 640, 1, 'QuintIn')--QuintIn
...
function onTimerCompleted(tag, loops, loopsLeft)
	if tag == 'nexttween' then
		doTweenX('Luatext001tweenXout', 'Luatext001', -200, 1, 'QuintIn')--QuintIn
		doTweenX('Luatext002tweenXout', 'Luatext002', 1280, 1, 'QuintIn')--QuintIn
